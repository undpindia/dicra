    ...
    return (
      ...
      >
        ...
        <div
          ...
          style={this.props.CurrentLayer == "FIREEV"||this.props.CurrentLayer == "WEATHER" ? { display: "none" } : {}}
        >
          <Legend />
        </div>
        <div
      ...
      <div className="container">
        ...
        >
          <div className="col-md-2" style={{ color: "rgba(215 215 215)" }}>
          <img src={Marker}  width="13px" />
          </div>
          <div className="col" style={{ color: "rgba(215 215 215)",  fontWeight: "bold" }}>
            Fire Events
          </div>
          <div className="w-100"></div>
          <div className="col" style={{ color: "rgba(215 215 215)", fontSize:"10px", marginTop:"10px" }}>
