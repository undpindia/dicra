...
#TEST
boundary_directory = '/content/drive/MyDrive/DiCRA_DPPD/Gujarat/administrative_boundary/gujarat_district_boundary.geojson'

file_directory = '/content/drive/MyDrive/DiCRA_DPPD/Gujarat/dppd_layers/lai_deviance/processed_files/'

file_name_to_save = 'LAI_gujarat_district_deviance.json'

dppd_tif_name = '/content/drive/MyDrive/DPPD.tif'
