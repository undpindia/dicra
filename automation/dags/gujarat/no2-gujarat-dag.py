...
with DAG(
    ...
    download_path = "/opt/airflow/dags/scripts/gujarat/no2/no2-gujarat-download.py"
    ...
    # [END howto_operator_bash]
       ...
       # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/gujarat/no2/no2-gujarat-preprocess.py"
    ...
    # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/gujarat/no2/no2-gujarat-dppd.py"
    process_command = "python3 " + process_path
    if os.path.exists(process_path):
