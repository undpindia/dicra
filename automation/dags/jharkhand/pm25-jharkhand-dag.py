...
with DAG(
    ...
    download_path = "/opt/airflow/dags/scripts/jharkhand/pm25/pm25-jharkhand-download.py"
    ...
    # [END howto_operator_bash]
       ...
       # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/jharkhand/pm25/pm25-jharkhand-preprocess.py"
    ...
    # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/jharkhand/pm25/pm25-jharkhand-dppd.py"
    process_command = "python3 " + process_path
    if os.path.exists(process_path):
