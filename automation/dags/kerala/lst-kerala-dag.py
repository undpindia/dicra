...
with DAG(
    ...
    download_path = "/opt/airflow/dags/scripts/kerala/lst/lst-kerala-download.py"
    ...
    # [END howto_operator_bash]
       ...
       # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/kerala/lst/lst-kerala-preprocess.py"
    ...
    # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/kerala/lst/lst-kerala-dppd.py"
    process_command = "python3 " + process_path
    if os.path.exists(process_path):
