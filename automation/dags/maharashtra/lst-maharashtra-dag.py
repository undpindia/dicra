...
with DAG(
    ...
    download_path = "/opt/airflow/dags/scripts/maharashtra/lst-maharashtra-download.py"
    ...
    # [END howto_operator_bash]
       ...
       # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/maharashtra/lst-maharashtra-preprocess.py"
