...
with DAG(
    dag_id="pm25_maharashtra_dag.py",
    schedule="@monthly",
    start_date=pendulum.datetime(2023, 1, 1, tz="UTC"),
    catchup=False,
    dagrun_timeout=datetime.timedelta(minutes=60),
    tags=["pm25", "maharashtra"],
) as dag:
    ...
    download_path = "/opt/airflow/dags/scripts/maharashtra/pm25/pm25-maharashtra-download.py"
    ...
    # [END howto_operator_bash]
       ...
       # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/maharashtra/pm25/pm25-maharashtra-preprocess.py"
    ...
    # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/maharashtra/pm25/pm25-maharashtra-dppd.py"
    process_command = "python3 " + process_path
    if os.path.exists(process_path):
