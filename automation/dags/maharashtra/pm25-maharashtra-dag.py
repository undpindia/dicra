...
with DAG(
    ...
    download_path = "/opt/airflow/dags/scripts/maharashtra/pm25-maharashtra-download.py"
    ...
    # [END howto_operator_bash]
       ...
       # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/maharashtra/pm25-maharashtra-preprocess.py"
