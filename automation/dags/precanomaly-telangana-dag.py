...
with DAG(
    dag_id="precanomaly_telangana_dag.py",
    schedule="@monthly",
    start_date=pendulum.datetime(2023, 1, 1, tz="UTC"),
    catchup=False,
    dagrun_timeout=datetime.timedelta(minutes=60),
    tags=["precanomaly", "telangana"],
) as dag:
    ...
    download_path = "/opt/airflow/dags/scripts/precanomaly-telangana-download.py"
    ...
    # [END howto_operator_bash]
       ...
       # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/precanomaly-telangana-process.py"
    ...
    # [END howto_operator_bash]
           ...
           # [START howto_operator_bash]
    deviance_path = "/opt/airflow/dags/scripts/precanomaly-telangana-deviance.py"
