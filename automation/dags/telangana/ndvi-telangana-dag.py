...
with DAG(
    ...
    download_path = "/opt/airflow/dags/scripts/telangana/ndvi-telangana-download.py"
    ...
    # [END howto_operator_bash]
       ...
       # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/telangana/ndvi-telangana-preprocess.py"
