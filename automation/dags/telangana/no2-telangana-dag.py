...
with DAG(
    ...
    download_path = "/opt/airflow/dags/scripts/telangana/no2/no2-telangana-download.py"
    ...
    # [END howto_operator_bash]
       ...
       # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/telangana/no2/no2-telangana-preprocess.py"
    ...
    # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/telangana/no2/no2-telangana-dppd.py"
    process_command = "python3 " + process_path
    if os.path.exists(process_path):
