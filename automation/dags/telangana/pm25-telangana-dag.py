...
with DAG(
    ...
    download_path = "/opt/airflow/dags/scripts/telangana/pm25-telangana-download.py"
    ...
    # [END howto_operator_bash]
       ...
       # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/telangana/pm25-telangana-preprocess.py"
