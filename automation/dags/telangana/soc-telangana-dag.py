...
with DAG(
    ...
    download_path = "/opt/airflow/dags/scripts/telangana/soc/soc-telangana-download.py"
    ...
    # [END howto_operator_bash]
       ...
       # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/telangana/soc/soc-telangana-preprocess.py"
    ...
    # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/telangana/soc/soc-telangana-dppd.py"
    process_command = "python3 " + process_path
    if os.path.exists(process_path):
