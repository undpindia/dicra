...
with DAG(
    ...
    download_path = "/opt/airflow/dags/scripts/tempanomaly-telangana-download.py"
    ...
    # [END howto_operator_bash]
       ...
       # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/tempanomaly-telangana-process.py"
    ...
    # [END howto_operator_bash]
           ...
           # [START howto_operator_bash]
    deviance_path = "/opt/airflow/dags/scripts/tempanomaly-telangana-deviance.py"
