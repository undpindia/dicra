...
with DAG(
    dag_id="lai_uttarakhand_dag.py",
    schedule="@monthly",
    start_date=pendulum.datetime(2023, 1, 1, tz="UTC"),
    catchup=False,
    dagrun_timeout=datetime.timedelta(minutes=60),
    tags=["lai", "uttarakhand"],
) as dag:
    ...
    download_path = "/opt/airflow/dags/scripts/uttarakhand/lai/lai-uttarakhand-download.py"
    ...
    # [END howto_operator_bash]
       ...
       # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/uttarakhand/lai/lai-uttarakhand-preprocess.py"
    ...
    # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/uttarakhand/lai/lai-uttarakhand-dppd.py"
    process_command = "python3 " + process_path
    if os.path.exists(process_path):
