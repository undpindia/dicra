...
with DAG(
    dag_id="no2_uttarakhand_dag.py",
    schedule="@monthly",
    start_date=pendulum.datetime(2023, 1, 1, tz="UTC"),
    catchup=False,
    dagrun_timeout=datetime.timedelta(minutes=60),
    tags=["no2", "uttarakhand"],
) as dag:
    ...
    download_path = "/opt/airflow/dags/scripts/uttarakhand/no2/no2-uttarakhand-download.py"
    ...
    # [END howto_operator_bash]
       ...
       # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/uttarakhand/no2/no2-uttarakhand-preprocess.py"
    ...
    # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/uttarakhand/no2/no2-uttarakhand-dppd.py"
    process_command = "python3 " + process_path
    if os.path.exists(process_path):
