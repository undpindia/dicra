...
with DAG(
    ...
    download_path = "/opt/airflow/dags/scripts/uttarpradesh/ndvi-uttarpradesh-download.py"
    ...
    # [END howto_operator_bash]
       ...
       # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/uttarpradesh/ndvi-uttarpradesh-preprocess.py"
