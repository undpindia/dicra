...
with DAG(
    dag_id="ndwi_uttarpradesh_dag.py",
    schedule="@monthly",
    start_date=pendulum.datetime(2023, 1, 1, tz="UTC"),
    catchup=False,
    dagrun_timeout=datetime.timedelta(minutes=60),
    tags=["ndwi", "uttarpradesh"],
) as dag:
    ...
    download_path = "/opt/airflow/dags/scripts/uttarpradesh/ndwi-uttarpradesh-download.py"
    ...
    # [END howto_operator_bash]
       ...
       # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/uttarpradesh/ndwi-uttarpradesh-preprocess.py"
