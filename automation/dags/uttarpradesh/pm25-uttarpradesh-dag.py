...
with DAG(
    dag_id="pm25_uttarpradesh_dag.py",
    schedule="@monthly",
    start_date=pendulum.datetime(2023, 1, 1, tz="UTC"),
    catchup=False,
    dagrun_timeout=datetime.timedelta(minutes=60),
    tags=["pm25", "uttarpradesh"],
) as dag:
    ...
    download_path = "/opt/airflow/dags/scripts/uttarpradesh/pm25-uttarpradesh-download.py"
    ...
    # [END howto_operator_bash]
       ...
       # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/uttarpradesh/pm25-uttarpradesh-preprocess.py"
