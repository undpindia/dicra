...
with DAG(
    dag_id="ssm_uttarpradesh_dag.py",
    schedule="@monthly",
    start_date=pendulum.datetime(2023, 1, 1, tz="UTC"),
    catchup=False,
    dagrun_timeout=datetime.timedelta(minutes=60),
    tags=["ssm", "uttarpradesh"],
) as dag:
    ...
    download_path = "/opt/airflow/dags/scripts/uttarpradesh/ssm-uttarpradesh-download.py"
    ...
    # [END howto_operator_bash]
       ...
       # [START howto_operator_bash]
    process_path = "/opt/airflow/dags/scripts/uttarpradesh/ssm-uttarpradesh-preprocess.py"
