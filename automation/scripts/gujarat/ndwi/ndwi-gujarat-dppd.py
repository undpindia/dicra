...
boundary_directory = statebase + '/base/Gujarat_state_shapefile_for_clip.geojson'   #District or Taluka or 1km grid
...
dppd_tif_name = scriptbase + '/Gujarat_state_DPPD.tif'
