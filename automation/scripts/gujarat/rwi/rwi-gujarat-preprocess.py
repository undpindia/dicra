...
df_district_boundaries = gpd.read_file(districtboundryfile)
...
print('Total population - gujarat (2020): ',round(population_worldpop/1000000000,2),'billion')
...
rwi_gujarat = relative_wealth_data.clip(adm_name)                   #Clipping fire points with Telangana boundaries
...
df2 = rwi_gujarat[['latitude','longitude']]                     #create a dataframe with lat lon values of rwi dataframe
df2['rwi'] = list(rwi_gujarat['rwi'])                           #add column of rwi values
