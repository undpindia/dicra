...
boundary_directory = statebase + '/base/Jharkhand_state_shapefile_for_clip.geojson'   #District or Taluka or 1km grid
...
dppd_tif_name = scriptbase + '/Jharkhand_state_DPPD.tif'
