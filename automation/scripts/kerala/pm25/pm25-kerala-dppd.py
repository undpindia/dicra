...
boundary_directory = statebase + '/base/Kerala_state_shapefile_for_clip.geojson'   #District or Taluka or 1km grid
...
dppd_tif_name = scriptbase + '/Kerala_state_DPPD.tif'
