...
print('Total population - kerala (2020): ',round(population_worldpop/1000000000,2),'billion')
...
rwi_kerala = relative_wealth_data.clip(adm_name)                   #Clipping fire points with Telangana boundaries
...
df2 = rwi_kerala[['latitude','longitude']]                     #create a dataframe with lat lon values of rwi dataframe
df2['rwi'] = list(rwi_kerala['rwi'])                           #add column of rwi values
