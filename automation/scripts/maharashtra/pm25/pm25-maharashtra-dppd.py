...
boundary_directory = statebase + '/base/Maharashtra_state_shapefile_for_clip.geojson'   #District or Taluka or 1km grid
...
dppd_tif_name = scriptbase + '/Maharashtra_state_DPPD.tif'
