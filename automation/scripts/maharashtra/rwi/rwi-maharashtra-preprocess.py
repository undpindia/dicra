...
statebase = '/nfsdata/rwi/maharashtra'
...
print('Total population - maharashtra (2020): ',round(population_worldpop/1000000000,2),'billion')
...
rwi_maharashtra = relative_wealth_data.clip(adm_name)                   #Clipping fire points with Telangana boundaries
...
df2 = rwi_maharashtra[['latitude','longitude']]                     #create a dataframe with lat lon values of rwi dataframe
df2['rwi'] = list(rwi_maharashtra['rwi'])                           #add column of rwi values
