...
print('Total population - odisha (2020): ',round(population_worldpop/1000000000,2),'billion')
...
rwi_odisha = relative_wealth_data.clip(adm_name)                   #Clipping fire points with Telangana boundaries
...
df2 = rwi_odisha[['latitude','longitude']]                     #create a dataframe with lat lon values of rwi dataframe
df2['rwi'] = list(rwi_odisha['rwi'])                           #add column of rwi values
