...
statebase = '/nfsdata/rwi/telangana'
...
rwi_telangana = relative_wealth_data.clip(adm_name)                   #Clipping fire points with Telangana boundaries
...
df2 = rwi_telangana[['latitude','longitude']]                     #create a dataframe with lat lon values of rwi dataframe
df2['rwi'] = list(rwi_telangana['rwi'])                           #add column of rwi values
