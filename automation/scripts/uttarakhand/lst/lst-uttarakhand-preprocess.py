...
#arr = os.listdir('GEE_LSTtifs_scaled') #Don't hardcode the path string in multiple lines, use a variable
...
if cogfname not in os.listdir(scriptbase):
    ...
    print('cog_lst directory exists')
...
#cmd="rm -r GEE_LSTtifs_scaled clipped projected recalculated"
#print(cmd)
#try:
#    subp.check_call(str(cmd), shell=True)
#except:
