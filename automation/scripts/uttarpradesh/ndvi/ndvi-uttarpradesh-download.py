...
statebase = '/nfsdata/ndvi/uttar_pradesh'
...
geemap.ee_export_image_collection(collection_subset, out_dir = out, scale=image.select('NDVI').projection().nominalScale(), region=roi, file_per_band=True, crs='EPSG:4326')
