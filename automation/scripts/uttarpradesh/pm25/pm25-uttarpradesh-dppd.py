...
statebase = '/nfsdata/pm25/uttarpradesh'
...
boundary_directory = statebase + '/base/Uttarpradesh_state_shapefile_for_clip.geojson'   #District or Taluka or 1km grid


#file_directory = 'Directory of COG created files'
file_directory = statebase + "/process/cog_pm25"

file_name_to_save = 'state_boundaryname_deviance.json'

dppd_tif_name = scriptbase + '/Uttarpradesh_state_DPPD.tif'
