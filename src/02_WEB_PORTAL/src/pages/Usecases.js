...
class Usecases extends React.Component {
  ...
  ChangeCaseType = (e) => {
    console.log("USECASES", this.state.usecase);
    this.setState({
    ...
    if (e.target.value == "All") {
      ...
      console.log("NEW OBJECT", result[e.target.value]);
      this.setState({
  ...
  async addUsecase() {
    ...
    console.log("usecase data" + formData.values);
    const response = await axiosConfig
      .post("/addusecase", formData)
      .then((usecaseres) => {
        console.log("SUCCESS", usecaseres);
