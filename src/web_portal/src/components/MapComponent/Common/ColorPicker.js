...
import Colorscale from "../Common/Colorpicker/ColorScaleIndex";
import ColorscalePicker from "../Common/Colorpicker/ColorPickerIndex";
import {
  DEFAULTDEVCF_SCALE,
  DEFAULTDEV_SCALE,
  DEFAULT_SCALE
} from "../Common//Colorpicker/constants";
          ...
          <Row>
            <Col>
              <Row>
                ...
                { this.props.CurrentLayer === "LST_DPPD" ||this.props.CurrentLayer === "NO2_DPPD" || this.props.CurrentLayer === "PM25_DPPD" || this.props.CurrentLayer === "DPPD" ? (
                <Colorscale
